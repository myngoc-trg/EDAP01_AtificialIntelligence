    ...
    def step(self):
        ...
        Function DFS(problem):
            ...
            while (true):
                ...
                node = min_cost_value(fringe) #Get node with lowest path cost
        ...
        index_of_min_cost = np.argmin([item[2] for item in self._frontier])
        current_node, _, g, parent = self._frontier.pop(index_of_min_cost)
